//copy below code into hello-myo workspace and run for swift key style
...
public:
    ...
    void print()
    {
        ...
        //diagonals
        else if (roll_f < 1.5 && pitch_f < -0.5 && roll_f > 0.3){
            if (yaw_f > 0.2) {
                cout << "W" << endl;
            }
            else if (yaw_f < -0.2) {
        ...
        else if (roll_f > 1.5 && pitch_f > 0.5) {
            if (yaw_f > 0.2) {
                cout << "Y" << endl;
            }
            else if (yaw_f < -0.2) {
